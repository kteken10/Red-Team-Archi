...
def create_risk_scoring_agent() -> Agent:
    return Agent(
        ...
        instructions=[
            ...
            "Étape 1 : Calcule les pertes financières pour les attaques identifiées dans le rapport transmis par les agents précédents.",
            "  - Utilise les types d'attaque : 'smurfing_bypass', 'chainalysis_spoof', 'data_poisoning'.",
            "  - Paramètres indicatifs : smurfing (10 transactions, 4950€), chainalysis_spoof (1 transaction, 2 400 000€), data_poisoning (500 transactions, 12 000€).",
            "Étape 2 : Évalue le risque réglementaire en utilisant les gaps identifiés par l'Agent Compliance Breaker dans le rapport transmis ci-dessus.",
